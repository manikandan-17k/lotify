...
const require_versionSelector = require('./versionSelector-C9O0acWm.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.6.8");
