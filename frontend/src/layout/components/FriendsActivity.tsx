    ...
    <div className="h-full bg-zinc-900 rounded-lg flex flex-col">
      ...
      <ScrollArea className="flex-1">
        <div className="p-4 space-y-4">
          {users.map((user) => (
            <div key={user.id} className="cursor-pointer hover:bg-zinc-800/50 rounded-md transition-colors group">
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  {isPlaying ? (
                    <div className='mt-1'>
                      ...
                      <div className='text-xs text-zinc-400 truncate'>Taylor Swift</div>
                    </div>
                  ) : (
